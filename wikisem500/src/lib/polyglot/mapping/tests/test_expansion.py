...
suites = []
suites.append(unittest.TestLoader().loadTestsFromTestCase(DigitExpanderTest))
suites.append(unittest.TestLoader().loadTestsFromTestCase(CaseExpanderTest))
suites.append(unittest.TestLoader().loadTestsFromTestCase(MixedExpansionTest))
